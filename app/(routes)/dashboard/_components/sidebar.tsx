...
import { ChevronDown, Loader2, LogInIcon, LogOut } from 'lucide-react';
...
const Sidebar = () => {
    ...
    return (
        <aside className="fixed flex h-screen w-[275px] flex-col border-r border-neutral-700 p-[22px] ">
            <Popover>
                {/* LOGO */}
                <PopoverTrigger>
                    <div className="flex items-center gap-x-3 rounded-lg px-2 py-3 transition hover:bg-neutral-800">
                        <Image
                            ...
                            height={35}
                        />
                        <h2 className="flex flex-1 items-center gap-1 font-bold">
                            {isTeamLoading ? (
